...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.92,26.26.26.1";
  const port = "8090";
  const id = "mp-weixin_jOmJwv";
...
const pages = [
  ...
  {
    path: "pages/electrician_home/electrician_home",
    style: {
      navigationBarTitleText: "电工工作台"
    }
  },
  {
    path: "pages/dispatcher_home/dispatcher_home",
    style: {
      navigationBarTitleText: "调度员工作台"
    }
  },
  {
    path: "pages/power_on_apply/power_on_apply",
    style: {
      navigationBarTitleText: "送电申请"
    }
  },
  {
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "停电申请单"
    }
  },
  {
    path: "pages/poweroff/verify",
    style: {
      navigationBarTitleText: "电工验电"
    }
  },
  {
    path: "pages/poweroff/repair",
    style: {
      navigationBarTitleText: "电工检修"
    }
  },
  {
    path: "pages/poweroff/restore",
    style: {
      navigationBarTitleText: "电工送电"
    }
  },
  {
  ...
  {
    path: "pages/user_management/user_management",
    style: {
      navigationBarTitleText: "用户管理"
    }
  },
  {
    path: "pages/user_management_simple/user_management_simple",
    style: {
      navigationBarTitleText: "用户管理(简化版)"
    }
  },
  {
    path: "pages/user_management_light/user_management_light",
    style: {
      navigationBarTitleText: "用户管理(轻量版)"
    }
  },
  {
    path: "pages/stats/stats",
    style: {
      navigationBarTitleText: "系统统计"
    }
  },
  {
    path: "pages/repair/repair",
    style: {
      navigationBarTitleText: "检修管理"
    }
  },
  {
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/login/login": "用户登录", "pages/register/register": "用户注册", "pages/electrician_home/electrician_home": "电工工作台", "pages/dispatcher_home/dispatcher_home": "调度员工作台", "pages/power_on_apply/power_on_apply": "送电申请", "pages/approval/approval": "审批管理", "pages/approval/history": "历史记录", "pages/approval/detail": "申请详情", "pages/apply/apply": "停电申请单", "pages/poweroff/verify": "电工验电", "pages/poweroff/repair": "电工检修", "pages/poweroff/restore": "电工送电", "pages/admin/admin": "管理员", "pages/user_management/user_management": "用户管理", "pages/user_management_simple/user_management_simple": "用户管理(简化版)", "pages/user_management_light/user_management_light": "用户管理(轻量版)", "pages/stats/stats": "系统统计", "pages/repair/repair": "检修管理", "pages/index/index": "首页" };
